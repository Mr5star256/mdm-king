...
class MdmKingApp:
    ...
    def log_progress(self, pct):
        ...
        if threading.current_thread() is threading.main_thread(): _upd()
        else: self._enqueue_ui(_upd)
    ...
    def _do_auto_super_patch(self, path, ctx):
        ...
        try:
            ...
            _proc = _sp.Popen(
                [_py, _worker_script, '--patch-worker', _tmp],
            ...
            for _line in _proc.stdout:
                ...
                if _line.startswith('PROGRESS:'):
                    try:
                        ...
                        self._enqueue_ui(lambda p=_pct: self.log_progress(p))
                    except: pass
...
<p style="color:#585b70;font-size:11px;margin:0">If you didn't request this, please ignore this email.<br>MDM KING Security Tool</p>
    ...
    def _show_changelog_win():
        ...
        _text.tag_config('b', font=('Segoe UI', 10, 'bold'), foreground=COLORS['fg'])
        _text.tag_config('n', font=('Segoe UI', 10), foreground=COLORS['green'])
